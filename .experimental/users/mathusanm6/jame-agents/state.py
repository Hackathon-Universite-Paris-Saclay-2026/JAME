...
the orchestrator can expose a full AI-DLC Plan / Act / Reason log.
"""
...
class ReasoningEntry(TypedDict):
    agent: str
    phase: str   # AI-DLC phase, e.g. "INCEPTION/requirements", "CONSTRUCTION/build-and-test"
    stage: str   # AI-DLC stage within the phase, e.g. "triage", "review", "verdict"
    content: str

...
class AgentState(TypedDict):
    ...
    awaiting_specs_approval: bool  # True while pipeline is paused for specs review

    # ── Senior prompt queue (human injects instructions between iterations) ─
    senior_prompt_queue: list[str]  # queued instructions from human; consumed per iteration
